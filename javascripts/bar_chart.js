...
(function() {
  ...
  var tooltipTitle = svgBar
    .append('text')
    .attr({'x': (width + margin.left + margin.right)/2, 'y': height + margin.top + 10})
  ...
  var tooltipTotal = svgBar
    .append('text')
    .attr({'x':(width + margin.left + margin.right)/2, 'y': height + margin.top + 34})
    .attr({'text-anchor': 'middle'})
  ...
  function drawBars (data) {
    ...
    myBars.enter()
      ...
      .attr("fill", function (d) {return bar_color(d.act_descripcion);})
